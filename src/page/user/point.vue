 <template>
  <div id="point" class="page ">
    <head-top :head-title="'我的'+(appConfig.word?appConfig.word.point:'积分')" background="#ff4444" :go-back='true' :rightMenu="true"></head-top>
    <div class="p-a-all" @scroll="handleScroll">
      <section class="content_container">
        <section class="content">
          <header class="content_header">
            <span class="content_title_style">当前{{appConfig.word?appConfig.word.point:'积分'}}</span>
          </header>
          <p class="content_num">
      ...
      <p class="deal_detail">{{appConfig.word?appConfig.word.point:'积分'}}明细</p>
